-- Create quotes module tables and add referrer contact fields
BEGIN;

-- Extend referring_entities with additional contact fields
...
CREATE TABLE IF NOT EXISTS quote_items (
  ...
  item_type TEXT NOT NULL, -- study | package
